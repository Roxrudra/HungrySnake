# HungrySnake
Terminal based snake game with challenging levels (Inspired by the classic "Snake Xenxia" in old nokia phones) and optimized algorithm (sparse set/bijective map) written in C.
